...
The model we used for this analysis a multivariate normal distribution, as shown below in equation \ref{modeq}. Each of the terms in the model are also explicitly defined below. 
...
\caption{\label{fig:data} AR(1) Model compared with observations from data}
\end{figure}
...
\begin{tabular}{rr}
 ...
 & Coefficient Estimates \\ 
  \hline
  Season1:SolarN & 104.89 \\ 
  Season2:SolarN & 180.31 \\ 
  Season1:SolarY & 21.50 \\ 
  Season2:SolarY & 83.87 \\ 
   \hline
\end{tabular}
\end{table}

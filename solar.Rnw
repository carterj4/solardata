...
The guassian proccess model allows for data that is correlated in the response. 
The added flexibility in the correlation structure allows us to obtain more accurate variance estimates and thus our prediction intervals will be more accurate than if we fit an uncorrelated 
...
\begin{tabular}{rrrr}
 ...
 Coefficient & 2.5\% & Estimate & 97.5\% \\ 
  \hline
  Regular  & 93.10 & 104.89 & 116.67 \\ 
  Regular Peak & 161.19 & 180.31 & 199.44 \\ 
  Solar & 7.56 & 21.50 & 35.45 \\ 

...
We are also interested in the number of additional months until the customer regains their total investment from switching to solar power. The blue lines in figure \ref{future:pred} correspond to the estimated number of years and prediction intervals after switching to solar until the costumer regains their \$8000 dollar investment. We predict that it will take an additional 70 months (5.8 years) from February 2018 for solar power to pay for itself. This brings the total estimated time for solar to pay for itself to be 7 years and 8 months with a lower bound of the 95\% prediction interval at 7 years and 2 months and the upper bound at 8 years and 3 months. The width of this interval is only a year wide, which is a very good interval estimate for the amount of time it takes for solar to pay for itself. 
